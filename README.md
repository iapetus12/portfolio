...
**Sistemas:** Windows 10/11 · Arch Linux · Debian/Ubuntu · Bash
**Redes:** TCP/IP · DHCP/DNS · LAN/WiFi · Nmap · Wireshark (básico)
**Hardware:** Montaje · Diagnóstico · Periféricos · Clonación de discos
**Virtualización:** VirtualBox · VMware · Docker (básico)
**Soporte:** HelpDesk · Documentación · Ticketing · Atención al usuario
**Ofimática/Web:** LibreOffice/Office · HTML/CSS básico · Git/GitHub
...
1. **Escucho y documento.** Si no está escrito, no existe.
2. **Metodología.** Recon → enumeración → explotación/mitigación → informe.
3. **Comunicación clara.** Explico el problema sin jerga innecesaria al usuario final.
4. **Aprendizaje continuo.** Mi laboratorio es Arch + BlackArch; si no sé algo, lo monto y lo pruebo.
...
### Para ti (dueño del repo): qué editar

1. Cambia email/LinkedIn/teléfono en `README.md` y `docs/index.html`
2. Exporta tu CV a PDF y súbelo como `docs/cv.pdf` (hay plantilla en `docs/cv.md`)
3. Activa GitHub Pages: Settings → Pages → Source: `main` / `docs`
4. (Opcional) Crea el repo `iapetus12` con un `README.md` de perfil — GitHub lo muestra en tu portada

> Este portfolio está pensado para **SMR / Soporte microinformático**, no para "hacker". Es profesional, directo y ATS-friendly.